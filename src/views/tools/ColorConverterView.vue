  ...
  <div class="color-converter-view">
    ...
    <div class="color-converter-view__columns">
      ...
      <div class="color-converter-view__results">
        <template v-if="result">
          ...
          <NeuCard elevation="raised" class="color-converter-view__result-card">
            <div class="color-converter-view__result-header">
              ...
              <CopyButton :content="`rgb(${result.rgb.r}, ${result.rgb.g}, ${result.rgb.b})`" />
            </div>
          ...
          <NeuCard elevation="raised" class="color-converter-view__result-card">
            <div class="color-converter-view__result-header">
              ...
              <CopyButton :content="`hsl(${result.hsl.h}, ${result.hsl.s}%, ${result.hsl.l}%)`" />
            </div>
            <div class="color-converter-view__result-value">
        ...
        <NeuCard v-else elevation="raised" class="color-converter-view__placeholder-card">
          <div class="color-converter-view__placeholder">转换结果将在此显示...</div>
        </NeuCard>
      </div>
    </div>
  </div>
...
/* 占位卡片 */
.color-converter-view__placeholder-card {
  flex: 1;
  display: flex;
  min-height: 0;
}

.color-converter-view__placeholder-card :deep(.neu-card__body) {
  flex: 1;
  display: flex;
  align-items: center;
  justify-content: center;
...
.color-converter-view__placeholder {
  color: var(--text-muted);
  font-size: var(--font-size-base);
}
</style>
